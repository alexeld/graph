...
function Graph(structure, weighted) {
    if (!structure) {
...
Graph.prototype.weightOfPath = function (from, to) {
    ...
    _from = (typeof from === 'string') ? this.getNode(from) : from;
    _to   = (typeof to   === 'string') ? this.getNode(to)   : to; 

    // Do magic shortest path algo stuff here


    var e1 = this.inboundEdges(_to);
    return this._calculateWeight(e1);
};
